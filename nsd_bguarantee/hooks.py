...
doc_events = {
"Bank Guarantee": {
	"on_submit": "nsd_bguarantee.overrides.bank_guarantee.bank_guarantee.on_submit_1",
	"on_update_after_submit": "nsd_bguarantee.overrides.bank_guarantee.bank_guarantee.on_update_after_submit_1"
}
}
doctype_js = {
