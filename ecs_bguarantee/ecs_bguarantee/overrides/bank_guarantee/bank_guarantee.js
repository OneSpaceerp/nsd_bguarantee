...
frappe.ui.form.on("Bank Guarantee", "bank_guarantee_type", function(frm) {
    if (frm.doc.bank_guarantee_type == "Receiving") {
        frm.set_value("reference_doctype", "Purchase Order");
    } else if (frm.doc.bank_guarantee_type == "Providing") {
